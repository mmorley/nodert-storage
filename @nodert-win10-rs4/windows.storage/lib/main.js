...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Storage.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Storage.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.System', 'Windows.Storage.FileProperties', 'Windows.Storage.Search', 'Windows.Foundation', 'Windows.Storage.Streams', 'Windows.Storage.Provider'];
